    ...
    <div class="row px-0 py-3 content-container-for-stories align-items-center">
        ...
        <div class="col-12 px-0 d-flex flex-nowrap gap-3 mt-1" style="overflow-x: auto;">
            ...
            <div class="col-md-3 col-8 p-0 mt-4 story-video-wrapper ">
                <video class="story-video" src="{{asset('web/assets/images/video1.mp4')}}" autoplay muted loop
                    preload="none"></video>
                <a href="#" class="anchor-for-image-name-for-stories">
                    <img src="{{asset('web/assets/images/profile.png')}}" alt="sponsor">
            ...
            <div class="col-md-3 col-8 p-0 mt-4 story-video-wrapper ">
                <video class="story-video" src="{{asset('web/assets/images/video2.mp4')}}" autoplay muted loop
                    preload="none"></video>
                <a href="#" class="anchor-for-image-name-for-stories">
                    <img src="{{asset('web/assets/images/profile.png')}}" alt="sponsor">
                    <span class="span-in-video-profile-anchor">
            ...
            <div class="col-md-3 col-8 p-0 mt-4 story-video-wrapper ">
                <video class="story-video" src="{{asset('web/assets/images/video3.mp4')}}" autoplay muted loop
                    preload="none"></video>
                <a href="#" class="anchor-for-image-name-for-stories">
                    <img src="{{asset('web/assets/images/profile.png')}}" alt="sponsor">
                    <span class="span-in-video-profile-anchor">
                        ...
                        <div class="card deal-card">
                            ...
                            <a href="#" class="text-decoration-none text-dark d-flex flex-column h-100">
                                ...
                                <div class="deal-img d-flex align-items-center justify-content-center">
                                    <img src="{{asset('web/assets/images/hotel5.webp')}}" alt="Hotel Image"
                    ...
                    <div class="col-md-4 col-sm-6 div-for-deals-info mb-4">
                        <div class="card deal-card">
                            ...
                            <a href="#" class="text-decoration-none text-dark d-flex flex-column h-100">
                                ...
                                <!-- Image -->
                                <div class="deal-img d-flex align-items-center justify-content-center">
                                    <img src="{{asset('web/assets/images/hotel6.webp')}}" alt="Hotel Image"
                                        class="deal-img-fluid">
                    ...
                    <div class="col-md-4 col-sm-6 div-for-deals-info mb-4">
                        <div class="card deal-card">
                            ...
                            <a href="#" class="text-decoration-none text-dark d-flex flex-column h-100">
                                ...
                                <!-- Image -->
                                <div class="deal-img d-flex align-items-center justify-content-center">
                                    <img src="{{asset('web/assets/images/hotel4.webp')}}" alt="Hotel Image"
                                        class="deal-img-fluid">
                    ...
                    <div class="col-md-4 col-sm-6 div-for-deals-info mb-4">
                        <div class="card deal-card">
                            ...
                            <a href="#" class="text-decoration-none text-dark d-flex flex-column h-100">
                                ...
                                <!-- Image -->
                                <div class="deal-img d-flex align-items-center justify-content-center">
                                    <img src="{{asset('web/assets/images/hotel3.webp')}}" alt="Hotel Image"
                                        class="deal-img-fluid">
                    ...
                    <div class="col-md-4 col-sm-6 div-for-deals-info mb-4">
                        <div class="card deal-card">
                            ...
                            <a href="#" class="text-decoration-none text-dark d-flex flex-column h-100">
                                ...
                                <!-- Image -->
                                <div class="deal-img d-flex align-items-center justify-content-center">
                                    <img src="{{asset('web/assets/images/hotel1.webp')}}" alt="Hotel Image"
                                        class="deal-img-fluid">
