...
<div class="container-fluid main-div-for-hotel-page">
    ...
    <div class="row px-0 g-3 pt-sm-5 pt-2 d-flex align-items-stretch main-image-container-div-in-hotel">
        ...
        <div class="col-md-7">
            <img src="{{asset('web/assets/images/hotel1.webp')}}" class="big-image img-fluid h-100 w-100">
        </div>
        ...
        <div class="col-md-5">
            <div class="row px-0 g-3">
                ...
                <div class="col-6">
                    <img src="{{asset('web/assets/images/hotel1.webp')}}" class="small-image img-fluid w-100">
                </div>
    ...
    <div class="row px-0 g-5 pt-sm-5 pt-2 amenities-hotel-section">
        ...
        <div class="col-md-6">
            ...
            <!-- Price Card -->
            <div class="price-check-in-out-info-div">
                <div class="card-body">
                    ...
                    <div class="div-for-comparisaon-in-hotel-info p-4 pb-0">

                        <!-- HEADING -->
                        <h6 class="mt-3 mb-4">Compare Prices</h6>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{asset('web/assets/images/hotel1.webp')}}" class="compare-img me-2">
                                <h6 class="mb-0">Roomer</h6>
                            </div>

                            <!-- RIGHT SIDE -->
                            <span class="price-right-in-hotel-info">$57 / night ></span>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{asset('web/assets/images/hotel1.webp')}}" class="compare-img me-2">
                                <h6 class="mb-0">Roomeno</h6>
                            </div>

                            <!-- RIGHT SIDE -->
                            <span class="price-right-in-hotel-info">$75 / night ></span>
                        </div>

                        <!-- VIEW ALL -->
                        <span class="view-all-btn mt-3 d-inline-block">View All ></span>
