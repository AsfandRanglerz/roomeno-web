    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <a class="btn btn-primary mb-3" href="{{ url('admin/protect-sellers') }}">Back</a>

                <form id="edit_farmer" action="{{ route('protectsellers.update', $seller->id) }}" method="POST"
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('main_title') is-invalid @enderror"
                                                id="main_title" name="main_title" value="{{ old('main_title', $seller->main_title) }}"
