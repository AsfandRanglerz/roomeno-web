...
@section('title', 'Roomeno Solutions')

@section('content')
<div class="main-content" style="min-height: 562px;">
    <section class="section">
        <div class="section-body">
            <a class="btn btn-primary mb-3" href="{{ route('roomenosolution.index')}}">Back</a>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Roomeno Solutions</h4>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $solution->description ?? '--' }}</td>
                                         <td>@if($solution && $solution->image)
                                            <img src="{{ asset($solution->image) }}" alt="" height="50"
