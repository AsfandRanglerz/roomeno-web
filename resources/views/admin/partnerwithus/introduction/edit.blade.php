    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <a class="btn btn-primary mb-3" href="{{ url('admin/partner-introduction') }}">Back</a>

                <form id="edit_farmer" action="{{ route('partnerintroduction.update', $intro->id) }}" method="POST"
