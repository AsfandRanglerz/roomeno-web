    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <a class="btn btn-primary mb-3" href="{{ url('admin/selling') }}">Back</a>

                <form id="edit_farmer" action="{{ route('selling.update', $selling->id) }}" method="POST"
                                    ...
                                    <div class="col-sm-6 pl-sm-0 pr-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('maintitle') is-invalid @enderror"
                                                id="maintitle" name="maintitle" value="{{ old('maintitle', $selling->main_title) }}"
