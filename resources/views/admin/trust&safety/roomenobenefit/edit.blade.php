    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <a class="btn btn-primary mb-3" href="{{ url('admin/roomeno-benefits-everyone') }}">Back</a>

                <form id="edit_farmer" action="{{ route('roomenobenefits.update', $benefit->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <h4 class="text-center my-4">Edit Roomeno Benefits Everyone</h4>
