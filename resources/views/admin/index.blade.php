                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15"> Total Listings</h5>
                                            <h2 class="mb-3 font-18">
                                                {{-- {{ $totalDealers }} --}}
                                            </h2>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Active Rooms </h5>
                                            <h2 class="mb-3 font-18">
                                                {{-- {{ $totalInsuranceCrops }} --}}
                                            </h2>
                                            {{-- <p class="mb-0"><span class="col-green">18%</span>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Revenue Summary </h5>
                                            <h2 class="mb-3 font-18">
                                                {{-- {{ $totalInsuranceCrops }} --}}
                                            </h2>
                                            {{-- <p class="mb-0"><span class="col-green">18%</span>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Top Hotels/Sellers </h5>
                                            <h2 class="mb-3 font-18">
                                                {{-- {{ $totalInsuranceCrops }} --}}
                                            </h2>
                                            {{-- <p class="mb-0"><span class="col-green">18%</span>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Payouts Pending </h5>
                                            <h2 class="mb-3 font-18">
                                                {{-- {{ $totalInsuranceCrops }} --}}
                                            </h2>
                                            {{-- <p class="mb-0"><span class="col-green">18%</span>
