...
@section('title','User Profile Info')
@section('content')
...
<div class="container-fluid py-5 main-container-div-for-user-profile">
        ...
        <div class="col-12 d-flex px-sm-5 px-1 user-profile-main-div">
            ...
            <div class="user-profile-text">
                ...
                <p class="user-detail-paragraph px-1 pt-2">
                    Vibhati Sharma ▪️ Creating moments that inspire travel. ▪️ Follow the journey. Find your escape
                </p>
    ...
    <div class="row px-0 px-sm-5 px-1 g-3 mt-1">
         <h3 class="py-3">Pending Videos</h3>
        <!-- Card 1 -->
        <div class="col-md-4 col-sm-6 p-0 px-3 mt-4 story-video-wrapper pending-video-wrapper">
