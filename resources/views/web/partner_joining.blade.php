...
@section('title','Login as Partner')
...
<div class="container-fluid bg-light">
    ...
    <section class="container pb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
            <div class="partner-thankyou-card text-center py-5">

                <h4 class="partner-thankyou-title">
                    Thanks For Joining!
                </h4>

                <div class="partner-check-icon">
                    <span><img src="{{ asset('public/web/assets/images/check-tick.png') }}" alt=""></span>
                </div>

                <p class="partner-thankyou-text">
