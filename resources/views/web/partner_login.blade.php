            ...
            <div class="col-md-6">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="d-flex text-center">
                        <div class="w-50 py-2 border-end border-bottom text-muted">JOIN</div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <button class="btn btn-login-in-oartner p-2 w-100 mb-3">
                            Log in
                        </button>

                        <div class="text-center small">
                            <a href="#" class="d-block mb-1 text-decoration-none text-black fw-bold">
